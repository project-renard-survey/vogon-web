...
var RelationTemplateResource = Vue.resource(BASE_URL + '/relationtemplate{/id}/', {}, {
    create: {
        method: 'POST',
        url: BASE_URL + '/relationtemplate{/id}/create/'
    },
    update: {
        method: 'PATCH',
...
var Relation2 = Vue.resource(BASE_URL + '/rest/relation{/id}');
var Prepare = Vue.resource(BASE_URL + '/relationtemplate{/id}/template{/template}/prepare/');